...
2. Olah Data Barang (CRUD Lengkap)
...
3. Fitur Multimedia (Multi-File Upload)
...
4. Tanda Tangan Digital (Canvas HTML5)
...
5. Tabel Pintar (Datatable & Paginasi)
...
6. Tampilan Modal (Pop-up) & Cetak Dokumen
